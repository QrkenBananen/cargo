...
",
    ...
    assert_eq!(
        ...
        cargo_toml::TomlProfile {
            ...
            debuginfo: Some(cargo_toml::TomlDebugInfo::Full),
...
fn profile_env_var_prefix() {
    ...
    assert_eq!(p.debuginfo, Some(cargo_toml::TomlDebugInfo::Limited));
...
fn all_profile_options() {
    ...
    let base_settings = cargo_toml::TomlProfile {
        ...
        debuginfo: Some(cargo_toml::TomlDebugInfo::Limited),
